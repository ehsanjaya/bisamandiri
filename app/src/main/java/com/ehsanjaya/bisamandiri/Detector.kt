...
import com.ehsanjaya.bisamandiri.MetaData.extractNamesFromLabelFile
import com.ehsanjaya.bisamandiri.MetaData.extractNamesFromMetadata
...
class Detector(
    ...
    fun detect(frame: Bitmap): DetectionResult? {
        ...
        return bestBoxes?.let { DetectionResult(it, inferenceTime) }
    }
            ...
            if (maxConf > CONFIDENCE_THRESHOLD) {
                ...
                boundingBoxes.add(
                    BoundingBox(
                        ...
                        cx = cx, cy = cy, w = w, h = h,
                        confidence = maxConf, indexClass = maxIdx, className = clsName
                    )
                )
            }
        }
    ...
    companion object {
        ...
        private const val CONFIDENCE_THRESHOLD = 0.005F
